...
//    }
    ...
    if (g_real_death_counter > g_current_scene->m_state.player->m_death_count && g_current_scene->m_state.player->m_death_count == 0) {
        g_current_scene->m_state.player->m_death_count = g_real_death_counter;
    }
    if (g_real_death_counter != g_current_scene->m_state.player->m_death_count) {
        g_real_death_counter = g_current_scene->m_state.player->m_death_count;
    }
